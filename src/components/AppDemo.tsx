    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-gradient`} x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#9a4aff" />
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: "#9a4aff", animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
        ...
        <div className="p-4">
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-electric-violet-600">1M</div>
              <div>6M</div>
              <div>1Y</div>
              <div>5Y</div>
            </div>
            ...
            <div className="mt-4 rounded-lg bg-electric-violet-500 px-4 py-2 text-center text-sm font-semibold text-white">
              Trade
            </div>
