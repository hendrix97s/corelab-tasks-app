    ...
    <AppScreen className="w-full">
      ...
      >
        <div className="px-4 py-6">
          ...
          <div className="mt-6 rounded-lg bg-electric-violet-500 px-3 py-2 text-center text-sm font-semibold text-white">
            Invite person
          </div>
        </div>
      </MotionAppScreenBody>
      ...
      >
        <div className="px-4 py-6">
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-electric-violet-500 px-3 py-2 text-center text-sm font-semibold text-white">
              Buy shares
            </div>
          </div>
        </div>
    ...
    >
      <TabList className="relative z-10 order-last col-span-6 space-y-6">
        {features.map((feature, featureIndex) => (
          <div
            key={feature.name}
            className="relative rounded-2xl transition-colors hover:bg-shark-900/30"
          >
            {featureIndex === selectedIndex && (
              <motion.div
                layoutId="activeBackground"
                className="absolute inset-0 bg-shark-900"
    ...
    <>
      ...
      >
        {features.map((feature, featureIndex) => (
          ...
          >
            <div className="relative transform overflow-hidden rounded-2xl bg-shark-900 px-5 py-6">
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                <CircleBackground
                  color="#9a4aff"
              ...
              <div className="absolute inset-x-0 bottom-0 bg-shark-900/75 p-6 backdrop-blur sm:p-10">
                <feature.icon className="h-8 w-8" />
                <h3 className="mt-6 text-sm font-semibold text-white sm:text-lg">
                  {feature.name}
                </h3>
                <p className="mt-2 text-sm text-shark-200">
                  {feature.description}
                </p>
              </div>
            </div>
...
export function PrimaryFeatures() {
  return (
    <section
      ...
      className="bg-shark-950 py-20 sm:py-32"
    >
      <Container>
